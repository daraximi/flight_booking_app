    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    Text("Miles acrued", style: Styles.headLineStyle4.copyWith(fontSize: 16)),
                    Text("13 November 2022", style: Styles.headLineStyle4.copyWith(fontSize: 16))
                  ],
                ),
                ...
                Row(
                  ...
                  children:const [
                    ...
                    alignment: CrossAxisAlignment.start,
                    isColor: false),
                    AppColumnLayout(firstText: "San Jose",
                    secondText: "Received from",
                    alignment: CrossAxisAlignment.end,
                    isColor: false)
                  ],
                ...
                Row(
                  ...
                  children: const [
                    ...
                    alignment: CrossAxisAlignment.start,
                    isColor: false),
                    AppColumnLayout(firstText: "Seattle",
                    secondText: "Received from",
                    alignment: CrossAxisAlignment.end,
                    isColor: false)
                  ],
          ...
          Gap(AppLayout.getHeight(25)),
          InkWell(
            onTap:(() => print("You have been tapped")),
            child: Center(
